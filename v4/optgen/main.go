...
func generateExprs(compiled CompiledExpr, w io.Writer) error {
	var gen exprsGen
	return generate(compiled, w, gen.generate)
}

func generateFactory(compiled CompiledExpr, w io.Writer) error {
	var gen factoryGen
	return generate(compiled, w, gen.generate)
}

func generateOps(compiled CompiledExpr, w io.Writer) error {
	var gen opsGen
	return generate(compiled, w, gen.generate)
}

func generate(compiled CompiledExpr, w io.Writer, genFunc func(compiled CompiledExpr, w io.Writer)) error {
